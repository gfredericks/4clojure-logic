[{:title "Failure"
  :description "The fail goal never succeeds. run* always returns
 ...
 {:title "Unification 5"
  ...
  :tags ["TRS"]}
 {:title "Lettings 1"
  :description "You can (somewhat) mix logic programming with functional programming."
 ...
 {:title "Oh man what is this doing"
  ...
  :tests ["(= __ (run* [r] (fresh [x] (let [y x] (fresh [x] (== [y x y] r))))))"]
  :tags ["TRS"]}
...
"(= __ (run* [q]
  ...
  :tags ["Me"]}
 {:title "Conde 4"
  :description "This description is unhelpful."
  :tests [
"(= __ (run* [q]
        (conde
          [(== q :foo) (== :baz :blizzles)]
 ...
 {:title "Conde 5"
  ...
  the I don't even"
  :tests ["(= __ (run* [q] (conde [fail succeed])))"]
  :tags ["TRS"]}
 {:title "Conde 6"
...
"(= __ (run* [q]
  ...
  :tags ["TRS"]}
 {:title "Sequences 3"
  :description "What if the list has logic variables in it? CAN ALL THIS REALLY WORK??"
  :tests [
"(= __ (run* [r]
        (fresh [x y]
          (firsto [r y] x)
  ...
  :tags ["TRS"]}
 {:title "Sequences 4"
  :description "Conso is the relational version of cons. (conso a b c) declares that c is
...
"(= __ (run* [r]
  ...
  :tags ["TRS"]}
 {:title "Sequences 6"
  :description "Try to write a relation that succeeds when its input is a list. Note that strings are not considered sequences by the core.logic unifier."
...
"(= __ (set
 ...
 {:title "Writing relations 1"
  :description "Write a relation that succeeds when its input is a list of doubly-repeated elements."
  :tests ["(= ['_0] (letfn [(twinsies [x] __)] (run* [q] (twinsies [:a :a :b :b :c :c]) (twinsies []))))"
...
"(= [[:a :b]] (letfn [(twinsies [x] __)]
 ...
 {:title "Writing relations 2"
  :description "Write a relation that succeeds when its input is a list of pairs of elements."
  :tests ["(= ['_0] (letfn [(twinsies [x] __)] (run* [q] (twinsies [[:a :a] [:b :b] [:c :c]]) (twinsies []))))"
          "(= [] (letfn [(twinsies [x] __)] (run* [q] (twinsies [[:a :a] [:b :b] [:c :c] 42]))))"
"(= [[:a :b]] (letfn [(twinsies [x] __)]
               (run* [x y] (twinsies [[7 7] [:a x] [y :b]]))))"]
